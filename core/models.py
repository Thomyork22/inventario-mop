...
class AsignacionEquipo(models.Model):
    ...
    nombre_responsable_entrega = models.CharField(max_length=150, blank=True, null=True)
    fecha_entrega_excel = models.DateField(blank=True, null=True)
...
class Equipo(models.Model):
    ...
    direccion_oficina_piso = models.CharField(max_length=255, blank=True, null=True)
    ...
    observaciones = models.TextField(blank=True, null=True)
    raw_excel_data = models.JSONField(blank=True, null=True)
...
class EquipoMonitor(models.Model):
    ...
    sigac_monitor = models.CharField(max_length=100, blank=True, null=True)
